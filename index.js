...
bot.onText(/^\/help|start$/, (msg, match) => {
    ...
    var txt = "Hi. You can use the Bot by sending the following commands:\n\
...
function getToken(accountName, password) {
    return new Promise((resolve, reject) => {
        ...
        fetchPost('https://api.bittrading.to/api/Account/Login', acc, (st, data) => {
            if (st == 1) {
...
function Order(amount = 1, type = 1) {
    return new Promise((resolve, reject) => {
        ...
        console.log(order);
        fetchPost('https://api.bittrading.to/api/Account/AccountPlaceOrder', order, (st, data) => {
            if (st == 1) {
                var result = data.data;
                resolve(result);
            } else {
...
function getCandlesticks(num = 10) {
    return new Promise((resolve, reject) => {
        ...
        fetchGet('https://api.bittrading.to/api/Account/CandleChartGetPrice', { params: qs }, (st, data) => {
            if (st == 1) {
                var result = data.data;
                resolve(result);
            } else {
...
function getResultOrder() {
    return new Promise((resolve, reject) => {
        fetchGet('https://api.bittrading.to/api/Account/GetResultOrder', null, (st, data) => {
            if (st == 1) {
                var result = data.data;
                resolve(result);
            } else {
...
function getBalance() {
    return new Promise((resolve, reject) => {
        fetchGet('https://api.bittrading.to/api/Account/GetBalance', null, (st, data) => {
            if (st == 1) {
                var result = data.data;
                resolve(result);
            } else {
...
function getOrderHistory(to, from = '2020-01-01', pageIndex = 1, pagesize = 999) {
    return new Promise((resolve, reject) => {
        ...
        fetchGet('https://api.bittrading.to/api/Account/BotPlaceOrderHistory', {
            params: qr
        }, (st, data) => {
            if (st == 1) {
                var result = data.data;
